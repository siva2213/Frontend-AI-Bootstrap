...
export const Sidebar = memo<SidebarProps>(({ open = true, onClose, onToggle, variant }) => {
  ...
  const listItems = useMemo(
    ...
    [sidebarLinks, location.pathname, handleNavigateClick, handleNavigateKeyDown, theme.palette]
  );
