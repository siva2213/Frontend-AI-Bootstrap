...
**Rules Version:** 1.0.0  
**Last Updated:** 2025-11-21T10:37:13.647Z
...
- **Component Standards**: [docs/rules/component-standards.md](docs/rules/component-standards.md)
- **Folder Structure**: [docs/rules/folder-structure.md](docs/rules/folder-structure.md)
- **Testing**: [docs/rules/testing.md](docs/rules/testing.md)
- **Routing**: [docs/rules/routing.md](docs/rules/routing.md)
- **State Management**: [docs/rules/state-management.md](docs/rules/state-management.md)
- **API Integration**: [docs/rules/api-integration.md](docs/rules/api-integration.md)
- **AI Tool Integration**: [docs/rules/ai-tool-integration.md](docs/rules/ai-tool-integration.md)
- **Full Rules**: [docs/README.md](docs/rules/README.md)
...
- AI Tool Integration: docs/rules/ai-tool-integration.md
